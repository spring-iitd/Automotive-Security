...
def main():
    ...
    surr_model_path = "./Trained_Models/densenet161_dos.pth"
    test_model_path = "./Trained_Models/resnet_dos.pth"
    # test_model_path = "Trained_Models/dos_spoof_wisa.pth"
    
    # output_path = "blackbox_final_v_0_1_sq_k=12"
    output_path = "blackbox_dos"

    #folder and filename to save results
    folder = './CF_Results/dos'
   ...
   # List of max_perturbations to iterate over
    ...
    packet_level_data.to_csv("./blackbox_gear/packet_level_data.csv", index=False)
