...
def fgsm_attack_valid(image, data_grad,ep,perturbation_type,pack,existing_hex_ids):
    ...
    perturbed_image = gradient_perturbation(image, perturbed_image,mask,existing_hex_ids)
    return perturbed_image

def apply_injection( pack, test_model,target,data_grad,data_denorm,ep,perturbation_type,existing_hex_ids):
    
    perturbed_data = fgsm_attack_valid(data_denorm, data_grad,ep,perturbation_type,pack,existing_hex_ids)
...
def gradient_perturbation(image, perturbed_image,mask,existing_hex_ids):
    ID_len = 11
    middle_bits = "0001000"
...
def fgsm_attack_modify(image,data_grad, epsilon,perturbation_type ,ID,Data, pack,matched_rows,selected_rows_set,bit_pattern,existing_hex_ids):
    # Collect the element-wise sign of the data gradient    
    sign_data_grad = data_grad.sign()
...
def apply_modification( pack, test_model,target,data_grad,data_denorm,ep,perturbation_type,ID,Data,matched_rows,selected_rows_set,bit_pattern,existing_hex_ids):
    
    
    perturbed_data,matched_rows,selected_rows_set = fgsm_attack_modify(data_denorm,data_grad, ep,perturbation_type ,ID,Data, pack,matched_rows,selected_rows_set,bit_pattern,existing_hex_ids)
    # print_image(perturbed_data,2,pack)
...
def Attack_procedure(model, test_model, device, test_loader, injection_type, modification_type, ep, max_injection_perturbations,output_path,bit_pattern,existing_hex_ids):
    pack = 1
    all_preds = []
    all_labels = []
    n_image = 1
            ...
            while continue_perturbation:
                ...
                if perturbation_type == "injection" and injection_count < max_injection_perturbations:
                    ...
                    continue_perturbation, pack, final_pred, data_denorm = apply_injection(
                        pack, test_model, target, data_grad, perturbed_data, ep,injection_type,existing_hex_ids
                    )
                    ...
                    continue_perturbation, pack, final_pred, data_denorm,matched_rows,selected_rows_set = apply_modification(
                        pack, test_model, target, data_grad, perturbed_data, ep,modification_type,target_ID,target_Data,matched_rows,selected_rows_set,bit_pattern,existing_hex_ids
                    )
...
def main():
    ...
    surr_model_path = "Trained_Models/wisa_carla.pth"
    test_model_path = "Trained_Models/wisa_carla.pth"
    # test_model_path = "Trained_Models/dos_spoof_wisa.pth"
    
    output_path = "blackbox_carla"

    #folder and filename to save results
    folder = '/home/ipali/scratch/code/PLAID-main/CF_Results'
    filename = 'blackbox_carla.png'
    ...
    bit_pattern = "0000010000010000011000" # for matching the packets/rows to modify 
   ...
   # List of max_perturbations to iterate over
    ...
    for max_injection_perturbations in max_perturbations_list:
        ...
        preds, labels = Attack_procedure(model, test_model, device, test_loader, injection_type, modification_type, epsilon, max_injection_perturbations,output_path,bit_pattern,existing_hex_ids)
        et = time.time()
        print("End time:", et)
        # print("Labels:", labels)
...
# Injection: random ID and Data both
...
#     # Create a mask to apply the sign data gradient only in the identified rows with max gradient
#     print("row selected for injection: ", max_grad_row.item())
#     mask = initialize_mask(data_grad)
#     mask = create_mask_for_max_grad_row(mask, max_grad_row, image.shape)
...
#     # perturbed_image = apply_constraint(image,mask,perturbed_image)
#     perturbed_image = gradient_perturbation_inject(image,perturbed_image,mask,existing_hex_ids)
#     return perturbed_image
...
#     if ifprint:
#         print("Initial matched rows for injection:", matched_rows)
...
# def gradient_perturbation_modify(image, perturbed_image,mask):
#     ID_len = 11
#     middle_bits = "0001000"
...
# def gradient_perturbation_inject(image, perturbed_image,mask,existing_hex_ids):
#     ID_len = 11
#     middle_bits = "0001000"
...
#     if perturbation_type == "Gradient":
#         perturbed_image = gradient_perturbation_modify(image, perturbed_image,mask)
...
#     injection_type = "Gradient"  
#     modification_type = "Gradient" 
#     bit_pattern = "0100001111110001000" #for matchign spoofed rows - 043F is the spoofed ECU.
#     existing_hex_ids = ['0000', '0130', '0002', '0131', '0140', '018f',
#                     '02c0', '0370', '0316', '0153', '043f', '0260',
#                     '02a0', '0350', '0440', '0329', '0545', '0430',
#                     '01f1', '04b1', '04f0', '05f0', '00a0', '00a1',
...
#         # Call the attack procedure 
#         preds, labels = Attack_procedure(model, test_model, device, test_loader, injection_type, modification_type, epsilon, max_injection_perturbations,image_save_path,bit_pattern,existing_hex_ids)
#         et = time.time()
#         print("End time:", et)
