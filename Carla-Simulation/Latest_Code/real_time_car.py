...
class CAN_Data_Logger(object):
    ...
    def log_data(self, index, time_diff_tick, steer_data, throttle_data, brake_data, gear_data,
        ...
        message_specs = [
            ...
            # ("dummy_1", lambda: self.log_dummy_data_1(), 0.017),
            # ("dummy_2", lambda: self.log_dummy_data_2(), 0.017),
            # ("dummy_3", lambda: self.log_dummy_data_3(), 0.017),
            # ("dummy_4", lambda: self.log_dummy_data_4(), 0.033),
            # ("dummy_5", lambda: self.log_dummy_data_5(), 0.033),
            # ("dummy_6", lambda: self.log_dummy_data_6(), 0.033),
    ...
    try:
        for i in range(total_iterations):  
            ...
            if agent_1.done():
                ...
                agent_1.set_destination(dest)
                agent_2.set_destination(dest)
        ...
        plot_gen_path_only_from_list(vehicle_location_1, "./Graphs/plot_gen_path_1.png", 0, total_iterations)
        plot_gen_path_only_from_list(vehicle_location_2, "./Graphs/plot_gen_path_2.png", 0, total_iterations)
...
def generate_dos_data_two_car():
    ...
    # dos_indices = generate_dos_indices(5900, 6400, 300)
    # dos_indices = generate_chunkwise_dos_indices(10800, 15, 1400, 35000)
    # dos_indices = generate_dos_indices(100, 25000, 12500)
    # print(dos_indices)
    # dos_indices = []
    ...
    dos_indices = generate_chunkwise_dos_indices(500, 10, 500, total_iterations)
    ...
    try:
        ...
        plot_vc_index(vehicle_control_obj_1,"./Graphs/plot_throttle_time_gen.png", "./Graphs/plot_steer_time_gen.png", "./Graphs/plot_brake_time_gen.png")
        plot_diff(timestamps, "./Graphs/plot_timestamp_diff_gen.png")
        plot_euclid_diff(vehicle_location_1, vehicle_location_2, timestamps, "./Graphs/plot_euclid_diff_benign.png")
        plot_gen_path_only_from_list(vehicle_location_1, "./Graphs/plot_gen_path_1.png", 0, total_iterations)
        plot_gen_path_only_from_list(vehicle_location_2, "./Graphs/plot_gen_path_2.png", 0, total_iterations)
        # plot_euclid_diff_single_function(vehicle_location_1, vehicle_location_2, timestamps,'./Logs_bkp','./Graphs/plot_euclid_diff_gen.png')
        # plot_euclid_diff_by_index_only(vehicle_location_1, vehicle_location_2,'./Logs_bkp', './Graphs/plot_euclid_diff_gen.png', 5600, 12000)
        # plot_gen_vs_rep_paths_from_files("./Logs_bkp/gen_coord_1.log", "./Logs/gen_coord_1.log", "./Graphs/benign_vs_attack_path.png", 5600, 12000)
