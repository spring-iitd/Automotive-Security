...
def convert_can_to_control_data_dos(file_path):
    ...
    # Use queues for each CAN ID to handle jitter
    msg_14A = deque()
    msg_17C = deque()
    msg_1A3 = deque()

    dos_indices = []
    index_counter = 0  # Position in control list
    ...
    with open(file_path, 'r') as file:
        for line in file:
            ...
            if can_id == 0x000:  # DoS indicator
                dos_indices.append(index_counter)
                continue

            # Append incoming messages to appropriate queue
            if can_id == 0x14A:
                msg_14A.append(msg)
            elif can_id == 0x17C:
                msg_17C.append(msg)
            ...
            # While a complete set is available, create VehicleControl
            while msg_14A and msg_17C and msg_1A3:
                steer_msg = msg_14A.popleft()
                throttle_msg = msg_17C.popleft()
                brake_msg = msg_1A3.popleft()

                throttle, steer, brake, _, _, _, gear = can_logger.parse_logs(
                    steer_msg, throttle_msg, brake_msg
                )
...
def replay_data_without_recovery():
    ...
    timestamp_writer = open('./Logs/rep_timestamp.log', 'w')
...
def replay_data_with_recovery_spoof():
    ...
    vehicle_control_writer = open('./Logs/vehicle_rep_control_log.log', 'w')
    timestamp_writer = open('./Logs/rep_timestamp.log', 'w')
    recovery_route_locations_reader = open('./Logs/gen_route_location.log', 'r')
...
def replay_data_with_recovery_dos_2():
    ...
    try:
        ...
        plot_gen_vs_rep_paths_from_files("./Logs/gen_coord_1.log", "./Logs/rep_coord_1.log", "./Graphs/gen_vs_rep_path.png", 0, 11000)
        # plot_vc_time(vehicle_control_1, timestarep, "./Graphs/plot_throttle_time_rep.png", "./Graphs/plot_steer_time_rep.png", "./Graphs/plot_brake_time_rep.png")
        # plot_euclid_diff_single_function(vehicreplocation_1, vehicle_location_2, timestamps,'./Logs', './Graphs/plot_euclid_diff_gen.png', 8000, 11000)
        plot_euclid_diff_by_index_only(vehicle_location_1, vehicle_location_2,'./Logs', './Graphs/plot_euclid_diff_gen.png', 0, 11000)
        plot_diff(timestamps,"./Graphs/prep_timestamp_diff_rep.png")
...
def replay_data_with_recovery_online_candump():
    ...
    vehicle_control_writer_2 = open('./Logs/rep_control_obj_2.log', 'w')
    timestamp_writer = open('./Logs/rep_timestamp.log', 'w')
    recovery_route_locations_reader = open('./Logs_Benign/gen_route_location.log', 'r')
    ...
    try:
        ...
        plot_gen_vs_rep_paths_from_files("./Logs/rep_coord_1.log", "./Logs/rep_coord_1.log", "./Graphs/gen_vs_rep_path.png", 0, 11000)
        # plot_vc_time(vehicle_control_1, timestarep, "./Graphs/plot_throttle_time_rep.png", "./Graphs/plot_steer_time_rep.png", "./Graphs/plot_brake_time_rep.png")
        # plot_euclid_diff_single_function(vehicreplocation_1, vehicle_location_2, timestamps,'./Logs', './Graphs/plot_euclid_diff_gen.png', 8000, 11000)
        plot_euclid_diff_by_index_only(vehicle_location_1, vehicle_location_2,'./Logs', './Graphs/plot_euclid_diff_gen.png', 0, 11000)
        plot_diff(timestamps,"./Graphs/prep_timestamp_diff_rep.png")
...
def replay_data_fixed_path():
    ...
    route_locations = []
    pattern = re.compile(r'Location\(x=([-.\d]+), y=([-.\d]+), z=([-.\d]+)\)')
    route_locations_reader = open('./Logs_Benign/gen_route_location.log', 'r')
    ...
    try:
        ...
        plot_gen_vs_rep_paths_from_files(
            ...
            "./Logs/rep_coord_1.log",
            "./Graprepgen_vs_rep_path.png",0,11000
        )
...
def replay_data_without_recovery_2():
    ...
    # Data collection
    vehicle_control_obj_1, _ = convert_can_to_control_data_dos('./Logs/can_data_logs.log')
    vehicle_control_obj_2 = extract_control_data('./Logs/gen_control_obj_2.log')
    # print(len(vehicle_control_obj_1), len(vehicle_control_obj_2))
    timestamps = []
    vehicle_location_1 = []
    vehicle_location_2 = []
    vehicle_velocity = []
    ...
    try:
        ...
        plot_gen_vs_rep_paths_from_files("./Logs/rep_coord_1.log", "./Logs/rep_coord_1.log", "./Graphs/gen_vs_rep_path.png", 0, 10000)
        # plot_vc_time(vehicle_control_1, timestarep, "./Graphs/plot_throttle_time_rep.png", "./Graphs/plot_steer_time_rep.png", "./Graphs/plot_brake_time_rep.png")
        # plot_euclid_diff_single_function(vehicle_location_1, vehicle_location_2, timestamps,'./Logs', './Graphs/plot_euclid_diff_gen.png')
        plot_euclid_diff_by_index_only(vehicle_location_1, vehicle_location_2,'./Logs', './Graphs/plot_euclid_diff_gen.png', 0, 10000)
        plot_diff(timestamps,"./Graphs/plot_timestamp_diff_rep.png")
        # plot_vc_index(vehicle_control_1, "./Graphs/plot_throttle_time_rep.png", "./Graphs/plot_steer_time_rep.png", "./Graphs/plot_brake_time_rep.png")
