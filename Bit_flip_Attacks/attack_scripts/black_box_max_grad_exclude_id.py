...
def main():
    ...
    output_path = "blackbox_final_v_0_1_sq_max_grad_id_0_k=12"

    #folder and filename to save results
    folder = './CF_Results_v_0_1_sq_max_grad_id_0_k=12'
    # folder = './CF_Results_test'
    filename = 'blackbox_ch_final_v_0_1_sq_max_grad_id_0_k=12.png'
   ...
   # List of max_perturbations to iterate over
    ...
    packet_level_data.to_csv("./blackbox_final_v_0_1_sq_max_grad_id_0_k=12/packet_level_data.csv", index=False)
