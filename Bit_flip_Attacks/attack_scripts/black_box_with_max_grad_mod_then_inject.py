...
def main():
    ...
    output_path = "blackbox_only_mod_max_grad_k=12"

    #folder and filename to save results
    folder = './CF_Results_only_mod_max_grad_k=12'
    # folder = './CF_Results_test'
    filename = 'blackbox_only_mod_max_grad_k=12.png'
   ...
   # List of max_perturbations to iterate over
    ...
    packet_level_data.to_csv("./blackbox_only_mod_max_grad_k=12/packet_level_data.csv", index=False)
