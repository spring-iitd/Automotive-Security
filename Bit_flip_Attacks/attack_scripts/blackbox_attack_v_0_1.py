...
def apply_inj_mod(data_grad, image, ep, existing_hex_ids, packet_level_data, n_image, modification_queue, injection_queue):
    ...
    # perturbed_image = bit_flip_random_attack_rgb(image, mask, data_grad, sign_data_grad)
    perturbed_image = bit_flip_random_data_attack_rgb(image, mask, data_grad, sign_data_grad)
