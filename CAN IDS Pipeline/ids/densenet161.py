...
class Densenet161(IDS):
    ...
    def test(self, X_test=None, Y_test=None, **kwargs):
        ...
        # test_dataset_dirs = kwargs.get('test_dataset_dirs') 
        # test_label_files = kwargs.get('test_label_files') 
    ...
    def test_model(self, test_loader, device,model):
        ...
        # model.load_state_dict(torch.load('/home/isha/Documents/Adv_Attacks_Defenses/test/Trained_Models/mirgu_new_d161.pth',map_location=torch.device('cpu'), weights_only='True'))
        model.eval()
