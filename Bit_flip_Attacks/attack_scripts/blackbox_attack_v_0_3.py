"""
   Description: Multiple Injection and Modification in each iteration on RGB images with Spoofing Images.
"""
...
def bit_flip_attack_rgb(image, mask, data_grad, sign_data_grad, injection_rows):
    """
...
def apply_inj_mod(data_grad, image, ep, existing_hex_ids, packet_level_data, n_image, modification_queue, injection_queue):
    ...
    perturbed_image = bit_flip_attack_rgb(image, mask, data_grad, sign_data_grad, injection_rows)
...
def main():
    ...
    # Change
    output_path = "blackbox_final_v_0_1_k=20"

    #folder and filename to save results
    # Change
    folder = './CF_Results_v_0_1_k=20'
    filename = 'blackbox_ch_final_v_0_1_k=20.png'
    ...
    #laod the model
    # Add new models if any inside load_model function
   ...
   # List of max_perturbations to iterate over
    ...
    # Change
    packet_level_data.to_csv("./blackbox_final_v_0_1_k=20/packet_level_data.csv", index=False)
