...
def generate_data_fixed_path():
    ...
    route_locations_reader = open('./Logs_Benign_TM_bkp/gen_route_location.log', 'r')
    ...
    timestamp_writer = open('./Logs/gen_timestamps.log', 'w')
    vehicle_route_location = open('./Logs/gen_route_location.log', 'w')
...
def generate_data_offline_candump():
    ...
    # Load the carla_map
    world = client.load_world('Town10HD_Opt', reset_settings=True, map_layers= carla.MapLayer.NONE)
    world.load_map_layer(carla.MapLayer.Buildings)
    world.load_map_layer(carla.MapLayer.Ground)
