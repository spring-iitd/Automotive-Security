...
def Attack_procedure(model, test_model, device, test_loader, injection_type, modification_type, ep, max_injection_perturbations,output_path,existing_hex_ids):
    pack = 1
    all_preds = []
    all_labels = []
    n_image = 1
...
def blackBoxAttack(surr_model_path, test_model_path):
...
#     existing_hex_ids = ['0130', '0140', '0340', '0153', '0160', '0164', '0220', '0386', '0387', '0389',
#  '038D', '0394', '0420', '0421', '047F', '0371', '0251', '02B0', '0372', '0470',
#  '050E', '0541', '0553', '04F1', '052A', '0485', '0381', '054B', '0559', '057F',
#  '0544', '0490', '007F', '0436', '0595', '050A', '0596', '0592', '050C', '0507',
#  '0520', '05C1', '05FF', '0495', '050B', '0500', '0593', '04A2', '05B0', '0412',
#  '04C9', '05BE', '0410', '05E3']
    
    # Mirgu
    existing_hex_ids = ['0470', '0130', '0421', '0386', '0381', '0371', '0372', '0164', '0340', '0436',
 '0394', '0140', '054B', '0160', '0387', '0251', '04F1', '047F', '0420', '02B0',
 '05FF', '0490', '0507', '038D', '0153', '0389', '0220', '0485', '05E3', '05B0',
 '0553', '05C1', '0596', '04C9', '0520', '0495', '0559', '0595', '0500', '050C',
 '050B', '052A', '0592', '04A2', '050E', '0541', '050A', '0544', '0593', '0412',
 '0410', '057F', '007F', '05BE']
   ...
   # List of max_perturbations to iterate over
    ...
    for max_injection_perturbations in max_perturbations_list:
        ...
        preds, labels = Attack_procedure(model, test_model, device, test_loader, injection_type, modification_type, epsilon, max_injection_perturbations,output_path,existing_hex_ids)
        et = time.time()
        print("End time:", et)
        # print("Labels:", labels)
