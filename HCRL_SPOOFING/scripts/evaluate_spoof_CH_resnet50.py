...
def save_preds(pass_num, tracksheet, preds_dict, output_path, tracksheet_dir="tracksheets_CH"):
    """
...
def plot_confusion(cm, pass_num,y_test,preds):
    ...
    plt.savefig("./CF_target/res50_spoof_cf_pass_{}.png".format(pass_num))
...
def run(params):
    ...
    log_result(
        ...
        round_num=rounds, model_name="ResNet50",
