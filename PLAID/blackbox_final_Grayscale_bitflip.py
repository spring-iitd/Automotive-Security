...
def main():
    ...
    output_path = "blackbox_ch_final_grayscale_bitflip_with_injection"

    #folder and filename to save results
    folder = './CF_Results_grayscale_bitflip_with_injection'
   ...
   # List of max_perturbations to iterate over
    ...
    packet_level_data.to_csv("./blackbox_ch_final_grayscale_bitflip_with_injection/packet_level_data.csv", index=False)
